# Hey there, I'm Ayush Roy 👋

🎓 B.Tech student at **Maharaja Surajmal Institute of Technology**, Delhi  
💻 Full-stack developer who builds real things and learns by doing  
🌱 Currently exploring **AI/ML**, **Web3**, and **systems programming**  
...
- 🔨 Finishing **Echo** — adding a React frontend to the WebSocket chat server
- 🧠 Learning **Python for AI/ML** — NumPy, Pandas, and model basics
- 🌐 Deep-diving **Web3** — Solana programs and Ethereum smart contracts
- 👀 Picking up **Golang** and **Rust** on the side
